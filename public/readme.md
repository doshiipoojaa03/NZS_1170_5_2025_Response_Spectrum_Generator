...
- According to the New Zealand Seismic Load Standard **(NZS 1170.5:2025)**, users can define variables, and based on those, the plugin generates spectral data for different periods.
